    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience_level', models.CharField(choices=[('student', 'Student'), ('fresher', 'Fresh Graduate (0-1 years)'), ('junior', 'Junior (1-3 years)'), ('mid', 'Mid-level (3-5 years)'), ('senior', 'Senior (5+ years)')], default='student', max_length=20)),
